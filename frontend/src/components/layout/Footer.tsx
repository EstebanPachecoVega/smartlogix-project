        ...
        <footer className="bg-card text-muted-foreground mt-auto border-t">
            <div className="container mx-auto px-4 py-10">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    {/* Políticas */}
                    <div>
                        <h3 className="text-foreground font-semibold mb-4">Políticas</h3>
                        <ul className="space-y-2 text-sm">
                            <li>
                            ...
                            <li>
                                <Link href="/privacidad-y-seguridad" className="hover:text-foreground transition-colors">
                                    Privacidad y Seguridad
                                </Link>
                            </li>
                            <li>
                                <Link href="/devolucion-y-reembolso" className="hover:text-foreground transition-colors">
                                    Devolución y Reembolso
                                </Link>
                            </li>
                            <li>
                                <Link href="/entrega-y-envios" className="hover:text-foreground transition-colors">
                                    Entrega y Envíos
                                </Link>
                            </li>
                        </ul>
                    ...
                    {/* Ubicación y horario */}
                    <div>
                        <h3 className="text-foreground font-semibold mb-4">Ubicación</h3>
                        <div className="space-y-3 text-sm">
                            ...
                            <div className="flex items-start gap-2">
                                ...
                                <span>
                                    <strong className="text-foreground">Horario de Atención Tienda y Retiro</strong><br />
            ...
            <div className="border-t border-border">
                <div className="container mx-auto px-4 py-4 text-center text-sm text-muted-foreground/70">
